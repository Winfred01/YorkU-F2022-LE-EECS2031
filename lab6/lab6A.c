...
// set value of variable k to be 5 via its pointer in the array arrP  
 ...
 // print the pointee of the 1st element pointer of planets (i.e., string "Mercury") , 
 ...
 /*********lastly, access some characters in the pointee array ******************/
